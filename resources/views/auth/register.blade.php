    ...
    <div class="flex justify-center">
        <div class="w-4/12 bg-white p-6 rounded-lg">
            <form action="{{ route('register') }}" method="post">
                ...
                <div class="mb-4">
                    <label for="password_confimation" class="sr-only">Password again</label>
                    <input type="password" name="password_confimation" id="password_confimation" placeholder="Repeat password" 
